...
(function () {
  ...
  class SearchEngine {
    ...
    //
    // Returns { results, errors, filters } rather than a bare array: a rejected
    ...
    search(query, limit = 100, opts = {}) {
      ...
      const { filters, errors } = parsed;
      const q = parsed.text;
      const predicate = OmniQuery.toPredicate(filters);
      const empty = { results: [], errors, filters };
      ...
      return { results: out.slice(0, limit), errors, filters };
    }
