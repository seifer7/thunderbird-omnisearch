...
(function () {
  ...
  // Recursively flatten every folder across every account into a flat list.
  ...
  globalThis.OmniIndexer = { flattenFolders, headerToDoc, fullBuild, collectAllMessageIds };
})();
